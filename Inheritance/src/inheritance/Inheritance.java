...
import Electronics.AlarmClock;
import Electronics.CellPhone;
import Electronics.Clock;
import Electronics.IPod;
import Electronics.Printer;
import Electronics.WallClock;
...
public class Inheritance 
{
    public static void main(String[] args) 
    {
        ...
        System.out.println("Current time: " + wClock.getCurrentTime());
        System.out.println("New time will be set to 3:45pm.");
        wClock.setCurrentTime("3:45pm");
        System.out.println(wClock.toString() + "\n");
        
        System.out.println("Alarm Clock\n"); 
        System.out.println("Current time: " + aClock.getCurrentTime());
        System.out.println("New time will match wall clock.");
        aClock.setCurrentTime(wClock.getCurrentTime());
